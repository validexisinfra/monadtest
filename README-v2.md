...
**v2** brings the install down to 15-30 minutes (vs ~8 hours in v1) via state snapshot restore, fixes apt dependency conflicts on noble, and removes private-key leaks from logs.
